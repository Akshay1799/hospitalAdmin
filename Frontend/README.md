...
lib/
  ...
  mode-context.tsx          Selected workplace context for clinic/hospital data
```
...
The sidebar has one Workplace menu listing available clinics and hospitals.
Selecting a workplace changes the doctor panel data context. Clinic workplaces
show clinic operations; hospital workplaces show hospital-scoped doctor data.
