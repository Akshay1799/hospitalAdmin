...
export const patients: Patient[] = [
  {
    ...
    latestVitals: {
      recordedAt: "2026-08-06T09:15:00",
      bp: "142/92",
      pulse: 88,
      temp: 98.6,
      spo2: 97,
  ...
  },
  {
    ...
    latestVitals: {
      recordedAt: "2026-08-10T11:00:00",
      bp: "118/76",
      pulse: 72,
      temp: 98.2,
      spo2: 99,
  ...
  },
  {
    ...
    latestVitals: {
      recordedAt: "2026-08-11T15:40:00",
      bp: "150/95",
      pulse: 96,
      temp: 99.1,
      spo2: 93,
  ...
  },
  {
    ...
    latestVitals: {
      recordedAt: "2026-07-29T10:05:00",
      bp: "122/80",
      pulse: 78,
      temp: 98.4,
      spo2: 98,
...
export const appointments: Appointment[] = [
  ...
  { id: "apt-7", patientId: "pat-1", doctorId: "doc-1", locationId: "loc-1", date: "2026-08-06", time: "09:00 AM", durationMins: 20, type: "In-Person", status: "Completed", reason: "Routine follow-up" },
  { id: "apt-8", patientId: "pat-4", doctorId: "doc-1", locationId: "loc-1", date: "2026-08-14", time: "04:00 PM", durationMins: 15, type: "Video", status: "Scheduled", reason: "Lab results discussion" },
  ...
  { id: "apt-10", patientId: "pat-7", doctorId: "doc-1", locationId: "hosp-1", workContext: "hospital", date: "2026-08-14", time: "07:30 AM", durationMins: 20, type: "In-Person", status: "Scheduled", reason: "Morning discharge clearance" },
];

export const diagnoses: DiagnosisEntry[] = [
  { id: "dx-1", patientId: "pat-1", icdCode: "E11.9", description: "Type 2 diabetes mellitus without complications", diagnosedOn: "2024-02-10", status: "Chronic", doctorId: "doc-1" },
  { id: "dx-2", patientId: "pat-1", icdCode: "I10", description: "Essential (primary) hypertension", diagnosedOn: "2024-02-10", status: "Chronic", doctorId: "doc-1" },
  { id: "dx-3", patientId: "pat-3", icdCode: "I25.10", description: "Atherosclerotic heart disease of native coronary artery", diagnosedOn: "2022-11-03", status: "Chronic", doctorId: "doc-1" },
...
export const labOrders: LabOrder[] = [
  { id: "lab-1", patientId: "pat-1", doctorId: "doc-1", testName: "HbA1c", orderedOn: "2026-08-06", status: "Report Ready", source: "Internal", priority: "Routine" },
  { id: "lab-2", patientId: "pat-1", doctorId: "doc-1", testName: "Lipid Profile", orderedOn: "2026-08-06", status: "In Progress", source: "Internal", priority: "Routine" },
  { id: "lab-3", patientId: "pat-3", doctorId: "doc-1", testName: "Troponin-I", orderedOn: "2026-08-11", status: "Report Ready", source: "Partner Lab", priority: "Urgent" },
...
export const tasks: Task[] = [
  ...
  { id: "tk-3", title: "Call Meera Pillai — overdue thyroid follow-up", ownerName: "Priya Nambiar", dueDate: "2026-08-14", priority: "Medium", status: "Open" },
