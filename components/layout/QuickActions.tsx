...
import { Plus, Stethoscope, FilePlus2, FlaskConical, ScanLine, CalendarClock, UserPlus, Search } from "lucide-react";

const actions = [
  { label: "Find Care", icon: Search, href: "/discover" },
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 z-20 mt-1.5 w-60 card p-1.5">
            {actions.map((a) => {
              const Icon = a.icon;
              return (
                <button
