...
import { patients, appointments, prescriptions, labOrders } from "@/lib/mock-data";
...
export default function GlobalSearch() {
  ...
  const results: Result[] = useMemo(() => {
    ...
    appointments
      .filter((a) => a.reason.toLowerCase().includes(q))
      .slice(0, 3)
      .forEach((a) => {
    ...
    prescriptions
      .filter((rx) => rx.medicines.some((m) => m.name.toLowerCase().includes(q)))
      .slice(0, 3)
      .forEach((rx) => {
    ...
    labOrders
      .filter((l) => l.testName.toLowerCase().includes(q))
      .slice(0, 3)
      .forEach((l) => {
    ...
    <div className="relative flex-1 max-w-md">
      <div className="relative">
        ...
        <input
          ...
          placeholder="Search patients, appointments, prescriptions, tests…"
