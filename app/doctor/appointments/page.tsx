...
import { appointments as seedAppointments, clinic, doctors, getPatient, patients } from "@/lib/mock-data";
  ...
  return (
    <div>
      <SectionHeading
        ...
        title="Appointments"
        description="View, manage and organize your consultation schedule."
        action={
      ...
      <Card padded={false}>
        {filtered.length === 0 ? (
          <EmptyState title="No appointments here" description="Nothing scheduled in this range yet." />
        ) : (
