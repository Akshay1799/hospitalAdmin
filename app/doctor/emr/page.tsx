...
import { patients, diagnoses, prescriptions, labOrders, radiologyOrders } from "@/lib/mock-data";
  ...
  return (
    <div>
      <SectionHeading
        ...
        description="Complete record of diagnoses, prescriptions, investigations, allergies and treatment history across your patients."
      />
