...
import { patients, followUps as seedFollowUps, getPatient } from "@/lib/mock-data";
...
export default function FollowUpPage() {
  ...
  function schedule() {
    ...
    setFollowUps((prev) => [
      { id: `fu-${Date.now()}`, patientId, doctorId: "doc-1", dueDate, reason, status: "Upcoming" },
      ...prev,
    ]);
    setDueDate("");
    setReason("");
  ...
  return (
    <div>
      <SectionHeading
        ...
        description="Schedule future consultations, monitor follow-up visits, and maintain continuity of patient care."
      />
