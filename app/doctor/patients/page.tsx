...
import { patients, doctors, getDoctor } from "@/lib/mock-data";
...
export default function PatientsPage() {
  ...
  }, [patientRows, query, tagFilter]);

  const allTags = Array.from(new Set(patientRows.flatMap((p) => p.tags ?? [])));
  ...
  return (
    <div>
      <SectionHeading
        ...
        title="My Patients"
        description="Centralized list of your assigned patients, medical history and ongoing treatments."
        action={
