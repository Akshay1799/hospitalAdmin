...
import { patients, diagnoses as seedDx, getPatient } from "@/lib/mock-data";
  ...
  return (
    <div>
      <SectionHeading
        ...
        description="Document clinical diagnoses using standardized ICD codes to maintain accurate records and reporting."
      />
