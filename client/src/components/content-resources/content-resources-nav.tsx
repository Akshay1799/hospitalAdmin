...
export function ContentResourcesNav() {
  ...
  const navItems = [
    ...
    {
      label: "Articles CMS",
      href: "/content-resources/articles",
      icon: FileText,
    ...
    },
    {
      ...
      href: "/content-resources/patient-education",
      icon: GraduationCap,
    ...
    },
    {
      ...
      href: "/content-resources/doctor-content",
      icon: Stethoscope,
    },
    {
      label: "Department Content",
      href: "/content-resources/department-content",
      icon: Building2,
    },
  ];
