...
import {
  ...
  mockImagingSuites,
} from "@/lib/mock-data/radiology-extended-operations";
  ...
  const navItems = [
    {
      ...
      href: "/radiology",
      icon: Layers,
      active: pathname === "/radiology",
    },
    {
      label: "Scheduling",
      href: "/radiology/scheduling",
      icon: Calendar,
      active: pathname === "/radiology/scheduling",
    },
    {
      label: "Imaging Queue",
      href: "/radiology/imaging-queue",
      icon: Radio,
      badge: inProgressCount > 0 ? inProgressCount : undefined,
      badgeVariant: "cyan" as const,
      active: pathname === "/radiology/imaging-queue",
    },
    {
      label: "Reports Archive",
      href: "/radiology/reports",
      icon: FileCheck2,
      active: pathname === "/radiology/reports",
    },
    {
      label: "Awaiting Review",
      href: "/radiology/awaiting-review",
      icon: Clock,
      badge: awaitingReviewCount > 0 ? awaitingReviewCount : undefined,
      badgeVariant: "amber" as const,
      active: pathname === "/radiology/awaiting-review",
    },
    {
      label: "Critical Findings",
      href: "/radiology/critical-findings",
      icon: AlertOctagon,
      badge: criticalCount > 0 ? criticalCount : undefined,
      badgeVariant: "destructive" as const,
      active: pathname === "/radiology/critical-findings",
    },
    {
      label: "Radiologists",
      href: "/radiology/radiologists",
      icon: User,
      active: pathname === "/radiology/radiologists",
    },
    {
      label: "Equipment",
      ...
      active: pathname === "/radiology/equipment",
    },
    {
      label: "History",
      href: "/radiology/history",
      icon: History,
      active: pathname === "/radiology/history",
    },
  ];
