...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 rounded-xl border border-border bg-card p-6 shadow-panel duration-200 data-[state=open]:animate-fade-in max-h-[90vh] overflow-y-auto scrollbar-thin",
        className
      )}
      {...props}
    >
