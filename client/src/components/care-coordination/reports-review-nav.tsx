...
export function ReportsReviewNav() {
  ...
  const navItems = [
    {
      label: "All Pending",
      href: "/care-coordination/reports-review",
      icon: Inbox,
      badge: pendingCount,
    ...
    {
      label: "Doctor-wise",
      href: "/care-coordination/reports-review/doctor-wise",
      icon: UserCheck,
      badge: null,
    },
    {
      label: "Critical Reports",
      href: "/care-coordination/reports-review/critical",
      icon: AlertOctagon,
      badge: criticalCount,
    ...
    },
    {
      ...
      href: "/care-coordination/reports-review/overdue",
      icon: Clock,
      badge: overdueCount,
    ...
    {
      label: "Reviewed",
      href: "/care-coordination/reports-review/reviewed",
      icon: FileCheck2,
      badge: reviewedCount,
    ...
    },
    {
      ...
      href: "/care-coordination/reports-review/patient-notified",
      icon: Send,
        ...
        {navItems.map((item) => {
          ...
          const isActive =
            item.href === "/care-coordination/reports-review"
              ? pathname === "/care-coordination/reports-review"
              : pathname === item.href;
