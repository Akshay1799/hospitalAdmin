...
export function HospitalProfileNav({ activeTab, onTabChange }: HospitalProfileNavProps) {
  ...
  const navItems = [
    {
      ...
      label: "Basic Info",
      href: "/hospital-profile/basic-information",
      icon: Building2,
      badge: "Core",
    },
    {
      id: "departments",
      label: "Departments",
      href: "/hospital-profile/departments",
      icon: Stethoscope,
    ...
    },
    {
      id: "services",
      label: "Services",
      href: "/hospital-profile/services",
      icon: Scissors,
    ...
    },
    {
      id: "facilities",
      label: "Facilities",
      href: "/hospital-profile/facilities",
      icon: Layers,
    ...
    },
    {
      id: "contact",
      label: "Contact",
      href: "/hospital-profile/contact",
      icon: PhoneCall,
    },
    {
      id: "qlyno-profile",
      label: "Qlyno Profile",
      href: "/hospital-profile/qlyno-profile",
      icon: Globe,
  ...
  const handleSelect = (id: string, href: string) => {
    if (onTabChange) {
      ...
      router.push(`/hospital-profile?tab=${id}`);
    }
  };
