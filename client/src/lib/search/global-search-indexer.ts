...
import { mockHospitalReports } from "@/lib/mock-data/reports-analytics";
import { vendors, procurementRequests } from "@/lib/mock-data/vendors";
import {
  nurses,
  billingStaff,
  receptionists,
...
export const STANDARD_QUICK_ACTIONS: QuickActionItem[] = [
  ...
  },
  {
    ...
    href: "/surgical-cases/surgeon-requests",
