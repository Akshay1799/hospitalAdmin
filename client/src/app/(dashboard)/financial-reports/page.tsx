...
import { FinancialReportsNav } from "@/components/financial-reports/financial-reports-nav";
import {
  mockRevenueStreams,
  ...
  getScaledExpenses,
} from "@/lib/mock-data/financial-reports";
          ...
          <Card className="border-border hover:border-primary/50 transition-all shadow-xs flex flex-col justify-between">
            ...
            <CardContent className="p-4 pt-0">
              <div className="pt-3 border-t border-border flex items-center justify-between text-xs">
                ...
                <Link href="/financial-reports/revenue" className="text-primary font-semibold hover:underline flex items-center gap-1">
          ...
          <Card className="border-border hover:border-primary/50 transition-all shadow-xs flex flex-col justify-between">
            ...
            <CardContent className="p-4 pt-0">
              <div className="pt-3 border-t border-border flex items-center justify-between text-xs">
                ...
                <Link href="/financial-reports/collections" className="text-primary font-semibold hover:underline flex items-center gap-1">
                  Explore <ArrowRight className="h-3 w-3" />
                </Link>
              </div>
            </CardContent>
          ...
          <Card className="border-border hover:border-primary/50 transition-all shadow-xs flex flex-col justify-between">
            ...
            <CardContent className="p-4 pt-0">
              <div className="pt-3 border-t border-border flex items-center justify-between text-xs">
                ...
                <Link href="/financial-reports/outstanding" className="text-primary font-semibold hover:underline flex items-center gap-1">
                  Explore <ArrowRight className="h-3 w-3" />
                </Link>
              </div>
            </CardContent>
          ...
          <Card className="border-border hover:border-primary/50 transition-all shadow-xs flex flex-col justify-between">
            ...
            <CardContent className="p-4 pt-0">
              <div className="pt-3 border-t border-border flex items-center justify-between text-xs">
                ...
                <Link href="/financial-reports/department-revenue" className="text-primary font-semibold hover:underline flex items-center gap-1">
                  Explore <ArrowRight className="h-3 w-3" />
                </Link>
              </div>
            </CardContent>
          ...
          <Card className="border-border hover:border-primary/50 transition-all shadow-xs flex flex-col justify-between">
            ...
            <CardContent className="p-4 pt-0">
              <div className="pt-3 border-t border-border flex items-center justify-between text-xs">
                ...
                <Link href="/financial-reports/doctor-revenue" className="text-primary font-semibold hover:underline flex items-center gap-1">
                  Explore <ArrowRight className="h-3 w-3" />
                </Link>
              </div>
            </CardContent>
          ...
          <Card className="border-border hover:border-primary/50 transition-all shadow-xs flex flex-col justify-between">
            ...
            <CardContent className="p-4 pt-0">
              <div className="pt-3 border-t border-border flex items-center justify-between text-xs">
                ...
                <Link href="/financial-reports/service-revenue" className="text-primary font-semibold hover:underline flex items-center gap-1">
                  Explore <ArrowRight className="h-3 w-3" />
                </Link>
              </div>
            </CardContent>
          ...
          <Card className="border-border hover:border-primary/50 transition-all shadow-xs flex flex-col justify-between">
            ...
            <CardContent className="p-4 pt-0">
              <div className="pt-3 border-t border-border flex items-center justify-between text-xs">
                ...
                <Link href="/financial-reports/payment-reports" className="text-primary font-semibold hover:underline flex items-center gap-1">
                  Explore <ArrowRight className="h-3 w-3" />
                </Link>
              </div>
            </CardContent>
          ...
          <Card className="border-border hover:border-primary/50 transition-all shadow-xs flex flex-col justify-between bg-linear-to-br from-card via-card to-primary/5">
            ...
            <CardContent className="p-4 pt-0">
              <div className="pt-3 border-t border-border flex items-center justify-between text-xs">
                ...
                <Link href="/financial-reports/profit-expense" className="text-primary font-semibold hover:underline flex items-center gap-1">
