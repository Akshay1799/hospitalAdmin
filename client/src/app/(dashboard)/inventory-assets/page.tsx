...
import { mockBiomedicalAssets, mockInventoryCatalog } from "@/lib/mock-data/section12-operations";
        ...
        <Card className="border-border hover:border-primary/50 transition-all shadow-xs flex flex-col justify-between">
          ...
          <CardContent className="p-4 pt-0">
            <div className="pt-3 border-t border-border flex items-center justify-between text-xs">
              ...
              <Link href="/inventory" className="text-primary font-semibold hover:underline flex items-center gap-1">
        ...
        <Card className="border-border hover:border-primary/50 transition-all shadow-xs flex flex-col justify-between">
          ...
          <CardContent className="p-4 pt-0">
            <div className="pt-3 border-t border-border flex items-center justify-between text-xs">
              ...
              <Link href="/assets" className="text-primary font-semibold hover:underline flex items-center gap-1">
        ...
        <Card className="border-border hover:border-primary/50 transition-all shadow-xs flex flex-col justify-between">
          ...
          <CardContent className="p-4 pt-0">
            <div className="pt-3 border-t border-border flex items-center justify-between text-xs">
              ...
              <Link href="/procurement" className="text-primary font-semibold hover:underline flex items-center gap-1">
