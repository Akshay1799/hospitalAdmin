        ...
        <Card className="border-border hover:border-primary/50 transition-all shadow-xs flex flex-col justify-between">
          ...
          <CardContent className="p-4 pt-0">
            <div className="pt-3 border-t border-border flex items-center justify-between text-xs">
              ...
              <Link href="/staff/receptionists" className="text-primary font-semibold hover:underline flex items-center gap-1">
        ...
        <Card className="border-border hover:border-primary/50 transition-all shadow-xs flex flex-col justify-between">
          ...
          <CardContent className="p-4 pt-0">
            <div className="pt-3 border-t border-border flex items-center justify-between text-xs">
              ...
              <Link href="/appointments/opd-queue" className="text-primary font-semibold hover:underline flex items-center gap-1">
        ...
        <Card className="border-border hover:border-primary/50 transition-all shadow-xs flex flex-col justify-between">
          ...
          <CardContent className="p-4 pt-0">
            <div className="pt-3 border-t border-border flex items-center justify-between text-xs">
              ...
              <Link href="/appointments" className="text-primary font-semibold hover:underline flex items-center gap-1">
