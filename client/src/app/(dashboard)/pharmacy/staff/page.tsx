...
import { mockPharmacyStaff } from "@/lib/mock-data/pharmacy-extended-operations";
import { PharmacyStaffMember } from "@/lib/types";
    ...
    return (
      <div className="space-y-4 animate-fade-in pb-12">
        <PageHeader
          ...
          crumbs={[{ label: "Operations" }, { label: "Pharmacy", href: "/pharmacy" }, { label: "Pharmacy Staff" }]}
        />
