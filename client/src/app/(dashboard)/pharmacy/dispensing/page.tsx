...
import { mockDispensingLogs } from "@/lib/mock-data/section12-operations";
import { mockPharmacyPrescriptions } from "@/lib/mock-data/pharmacy-extended-operations";
import { DispensingRecord, PharmacyPrescription } from "@/lib/types";
    ...
    return (
      <div className="space-y-4 animate-fade-in pb-12">
        <PageHeader
          ...
          crumbs={[{ label: "Operations" }, { label: "Pharmacy", href: "/pharmacy" }, { label: "Dispensing" }]}
        />
