...
import { mockPharmacyBatchExpiries } from "@/lib/mock-data/pharmacy-extended-operations";
import { PharmacyBatchExpiry } from "@/lib/types";
    ...
    return (
      <div className="space-y-4 animate-fade-in pb-12">
        <PageHeader
          ...
          crumbs={[{ label: "Operations" }, { label: "Pharmacy", href: "/pharmacy" }, { label: "Expiry Management" }]}
        />
  ...
  return (
    <div className="space-y-4 animate-fade-in pb-12">
      <PageHeader
        ...
        crumbs={[{ label: "Operations" }, { label: "Pharmacy", href: "/pharmacy" }, { label: "Expiry Management" }]}
        actions={
          <Link href="/pharmacy/sales-returns">
