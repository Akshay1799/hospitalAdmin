...
import { VerificationCase, VerificationStatus, VerificationDocument } from "@/lib/types";
    ...
    return (
      <div className="space-y-4 animate-fade-in pb-12">
        <PageHeader
          ...
          crumbs={[{ label: "Administration" }, { label: "Verifications", href: "/verification" }, { label: "Case Review" }]}
        />
    ...
    <div className="space-y-4 animate-fade-in pb-12">
      ...
      <PageHeader
        ...
        crumbs={[
          ...
          { label: "Verifications", href: "/verification" },
