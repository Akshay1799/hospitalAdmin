    ...
    return (
      <div className="space-y-4 animate-fade-in pb-12">
        <PageHeader
          ...
          crumbs={[{ label: "Clinical Operations" }, { label: "Radiology", href: "/radiology" }, { label: "Reports Archive", href: "/radiology/reports" }]}
        />
        ...
        <div className="flex items-center gap-2">
          {report.dicomViewerUrl && (
            <Button size="sm" asChild className="gap-1.5 shadow-sm text-xs bg-slate-900 text-white hover:bg-slate-800 hover:text-white border border-slate-700">
              <Link href={`/radiology/viewer/${report.id}`}>
      ...
      <div className="print:hidden">
        <PageHeader
          ...
          crumbs={[
            ...
            { label: "Reports Archive", href: "/radiology/reports" },
