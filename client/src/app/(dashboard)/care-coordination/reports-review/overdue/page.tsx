...
import { ReportsReviewNav } from "@/components/care-coordination/reports-review-nav";
import { SignOffReportModal } from "@/components/care-coordination/SignOffReportModal";
import { AddendumClarificationModal } from "@/components/care-coordination/AddendumClarificationModal";
import { EscalateOverdueModal } from "@/components/care-coordination/EscalateOverdueModal";
import { ViewReportDetailDrawer } from "@/components/care-coordination/ViewReportDetailDrawer";
import { mockCareCoordinationReportsReview } from "@/lib/mock-data/reports-review-extended";
import { CareCoordinationReportReviewItem } from "@/lib/types";
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        ...
        crumbs={[
          { label: "Care Coordination", href: "/care-coordination/patient-journey" },
          { label: "Reports Awaiting Review", href: "/care-coordination/reports-review" },
