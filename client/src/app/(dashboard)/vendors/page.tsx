...
import { procurementRequests, vendors } from "@/lib/mock-data/vendors";
        ...
        actions={
          <>
            <Button variant="outline" asChild>
              <Link href="/vendors/procurement">Procurement Requests</Link>
            </Button>
        ...
        <Card className="mb-4 border-info/30 bg-info/5">
          <CardContent className="flex flex-wrap items-center justify-between gap-3 p-4">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link href="/vendors/procurement">Review requests</Link>
            </Button>
          </CardContent>
        </Card>
      )}
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem asChild>
                          <Link href={`/vendors/${v.id}`}>View profile</Link>
                        </DropdownMenuItem>
