    ...
    <div className="space-y-4 animate-fade-in pb-12 text-foreground">
        ...
        <Card className="border-border bg-card shadow-sm p-4 hover:border-indigo-500/40 transition-colors">
          <div className="flex items-center gap-3.5">
            ...
            <div className="min-w-0">
              ...
              <Link href="/doctors" className="text-[11px] font-semibold text-amber-600 dark:text-amber-400 hover:underline block">
                View all
              </Link>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
        ...
        <Card className="border-border bg-card shadow-sm flex flex-col justify-between">
          ...
          <div className="p-3 border-t border-border/80 text-center">
            <Link href="/care-coordination/patient-journey" className="text-xs font-semibold text-primary hover:underline">
              View full journey &gt;
            </Link>
          </div>
        </Card>
        ...
        <Card className="border-border bg-card shadow-sm flex flex-col justify-between">
              ...
              <tbody className="divide-y divide-border/40">
                <tr>
                  ...
                  <td className="py-2 text-right">
                    <Link href="/care-coordination/reports-review" className="text-muted-foreground hover:text-primary">
                      Dr. Kapoor &gt;
                    </Link>
                  </td>
                </tr>
          ...
          <div className="p-3 border-t border-border/80 text-center">
            <Link href="/care-coordination/reports-review" className="text-xs font-semibold text-primary hover:underline">
              View all reports &gt;
            </Link>
          </div>
        </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
        ...
        <Card className="border-border bg-card shadow-sm flex flex-col justify-between">
          ...
          <div className="p-3 border-t border-border/80 text-center">
            <Link href="/emergency" className="text-xs font-semibold text-primary hover:underline">
              View emergency &gt;
            </Link>
          </div>
        </Card>
