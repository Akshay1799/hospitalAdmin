...
} from "@/store/slices/ambulanceSlice";
import { triggerFallback } from "@/store/slices/emergencySlice";
import { RECEIVING_HOSPITALS } from "@/components/ambulance/DispatchCreationModal";
              ...
              <CardContent className="p-4 space-y-3.5 text-xs">
                ...
                <div className="p-3 rounded-lg bg-muted/30 border border-border space-y-1">
                  ...
                  {selectedAmbulance.currentCaseId ? (
                    <div>
                      <Link
                        href={`/emergency/${selectedAmbulance.currentCaseId}`}
