...
import { NursesNav } from "@/components/nurses/nurses-nav";
import { nurses, attendanceRecords } from "@/lib/mock-data/staff";
import { mockAuditLogs } from "@/lib/mock/nursing";
    ...
    return (
      <div className="space-y-4 animate-fade-in pb-12">
        <PageHeader
          ...
          crumbs={[{ label: "People & Staff" }, { label: "Nurses", href: "/nurses" }, { label: nurseId }]}
        />
        <NursesNav />
