...
import { StaffCoverageHeatmap } from "@/components/workforce/staff-coverage-heatmap";
...
} from "@/lib/mock-data/proposed-features";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="border-border shadow-xs border-l-4 border-l-rose-500">
          ...
          <CardContent className="p-3.5 pt-0 space-y-2 text-xs">
            ...
            <Link href="/emergency/emg_01" className="text-[11px] font-semibold text-primary hover:underline flex items-center gap-1 pt-1">
        ...
        <Card className="border-border shadow-xs border-l-4 border-l-amber-500">
          ...
          <CardContent className="p-3.5 pt-0 space-y-2 text-xs">
            ...
            <Link href="/wards-beds/cleaning" className="text-[11px] font-semibold text-primary hover:underline flex items-center gap-1 pt-1">
        ...
        <Card className="border-border shadow-xs border-l-4 border-l-primary">
          ...
          <CardContent className="p-3.5 pt-0 space-y-2 text-xs">
            ...
            <Link href="/surgical-cases" className="text-[11px] font-semibold text-primary hover:underline flex items-center gap-1 pt-1">
        ...
        <Card className="border-border shadow-xs border-l-4 border-l-indigo-500">
          ...
          <CardContent className="p-3.5 pt-0 space-y-2 text-xs">
            ...
            <Link href="/incidents" className="text-[11px] font-semibold text-primary hover:underline flex items-center gap-1 pt-1">
