...
import { RotateApiKeyModal } from "@/components/integrations/RotateApiKeyModal";
import { ConfigureWebhookModal } from "@/components/integrations/ConfigureWebhookModal";
import { TestFailoverModal } from "@/components/integrations/TestFailoverModal";
import {
...
export default function IntegrationsOverviewPage() {
  ...
  const categoryCards = [
    ...
    },
    {
      ...
      href: "/integrations/payment-gateway",
      icon: CreditCard,
      status: "Healthy",
    ...
    },
    {
      ...
      href: "/integrations/insurance-tpa",
      icon: ShieldCheck,
      status: "Healthy",
    ...
    },
    {
      ...
      href: "/integrations/external-systems",
      icon: Cpu,
      status: "Healthy",
