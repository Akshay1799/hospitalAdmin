...
import { toggleFailover } from "@/store/slices/integrationsSlice";
import { mockConnectors, mockWebhookEventLogs } from "@/lib/mock-data/integrations";
      ...
      <div className="border-b border-border bg-card px-6 py-4">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <a href="/care-coordination/communication/whatsapp">
