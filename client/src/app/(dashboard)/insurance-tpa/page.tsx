              ...
              <div className="p-3 bg-muted/20 rounded-lg border border-border space-y-1 text-[11px]">
                <div className="flex justify-between items-center">
                  ...
                  {selectedClaimForDetails.linkedInvoiceId ? (
                    <Link href="/billing" className="font-mono text-primary font-bold hover:underline">
                      {selectedClaimForDetails.linkedInvoiceId}
                    </Link>
                  ) : (
                ...
                {selectedClaimForDetails.settlementUtr && (
                  <div className="flex justify-between items-center pt-1">
                    ...
                    <Link href="/payments/online" className="font-mono text-purple-600 font-bold hover:underline">
                      {selectedClaimForDetails.settlementUtr}
                    </Link>
                  </div>
                )}
