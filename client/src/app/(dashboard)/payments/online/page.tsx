...
import { mockExtendedPaymentTransactions } from "@/lib/mock-data/payments-extended";
    ...
    return (
      <div className="space-y-4 animate-fade-in pb-12">
        <PageHeader
          ...
          crumbs={[{ label: "Finance" }, { label: "Payments", href: "/payments" }, { label: "Online" }]}
        />
                  ...
                  <TableRow key={tx.id} className="hover:bg-muted/30 text-xs">
                    ...
                    <TableCell>
                      <div className="space-y-0.5">
                        <Link href="/billing" className="font-mono text-primary hover:underline block">
                          {tx.invoiceId}
                        </Link>
                        {tx.tpaClaimNo && (
                          <Link href="/insurance-tpa" className="font-mono text-[10px] text-muted-foreground hover:underline block">
                            {tx.tpaClaimNo}
                          </Link>
                        )}
                      </div>
