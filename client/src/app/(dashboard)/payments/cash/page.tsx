...
} from "@/lib/mock-data/payments-extended";
import { PaymentTransaction, CashDrawerReport } from "@/lib/types";
    ...
    return (
      <div className="space-y-4 animate-fade-in pb-12">
        <PageHeader
          ...
          crumbs={[{ label: "Finance" }, { label: "Payments", href: "/payments" }, { label: "Cash" }]}
        />
